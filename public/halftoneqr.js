...
function drawPixel() {
  ...
  ctxPixel.imageSmoothingEnabled = ctxPixel.mozImageSmoothingEnabled = ctxPixel.msImageSmoothingEnabled = ctxPixel.webkitImageSmoothingEnabled = ctxTemp.imageSmoothingEnabled = ctxTemp.mozImageSmoothingEnabled = ctxTemp.msImageSmoothingEnabled = ctxTemp.webkitImageSmoothingEnabled = false;
...
function drawThreshold() {
  ...
  var pixels = ctxPixel.getImageData(
    0,
    0,
    canvasPixel.width,
    canvasPixel.height
    ...
    $("#go").on("click", function () {
      ...
      if (QRsize == -1) {
        if (userSize === 0) {
          ...
          alert(
            "Too much text. Try decreasing the error level or increasing the size."
          );
        }
        return;
      }
